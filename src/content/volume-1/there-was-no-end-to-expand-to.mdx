...
lastName: Guerra
firstName: Elijah
description: is the author of the chapbook <i>Feral Ecology</i> (Bottlecap Press 2024). Their first full-length poetry book, <i>Holograms in the Field</i>, won the inaugural Gasher Book Award and will be published in Spring 2026.
---
