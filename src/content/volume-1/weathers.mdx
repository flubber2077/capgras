...
lastName: Myers
firstName: Peter
description: is the author of the chapbooks <i>Brade Lands</i> (above/ground press) and <i>The Hangnail</i> (Belladonna*). His reviews and essays have been featured in <i>Chicago Review</i>, <i>Los Angeles Review of Books</i>, <i>Annulet</i>, and elsewhere.
---

rain falling freshly on freshly fallen snow already melted & falling over & over ice melted over
...
bod there goes teleology a canvas is copacetic although a circus is dubious one of us isn’t
...
words are feisty with no attribution I leave my room with the same words I came in with
smeared as the clouds the heartclick the unmurmured rain calling snow back up to the sky
because there isn’t time for that season that new thing it shouldn’t be happening the old is still
